...
data_path = 'c:\Bath\Year 5\FYP\EEG_BCI_Deep_Learning\BCI_IV_2a'
data_files = ['A0'+str(i)+'E.gdf' for i in range(1,10)]

label_path = 'C:\Bath\Year 5\FYP\EEG_BCI_Deep_Learning\BCI_IV_2a_mat'
...
for file in label_files:
    mat_data = sio.loadmat(os.path.join(label_path, file))
    ...
    for session_num in range(number_of_sessions):
        ...
        y.extend(labels)
    np.save(os.path.join(save_path, file[:-4]+'_label.npy'), y)
